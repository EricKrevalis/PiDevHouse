...
2. Verify every criterion by execution or code trace: run the checks, follow the paths. For UI, check semantic accessibility and trace visible behaviour, but dont do browser execution.
